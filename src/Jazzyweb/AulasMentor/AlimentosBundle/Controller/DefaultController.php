...
class DefaultController extends Controller {
    ...
    public function indexAction() {
        ...
        return $this->render(
                        'JazzywebAulasMentorAlimentosBundle:Default:index.html.twig', $params
        );
    }
    ...
    public function listarAction() {
        ...
        return
                $this->render(
                        'JazzywebAulasMentorAlimentosBundle:Default:mostrarAlimentos.html.twig', $params
        );
    }
    ...
    public function insertarAction() {
        ...
        return
                        $this
                        ->render(
                                'JazzywebAulasMentorAlimentosBundle:Default:formInsertar.html.twig', $params
        );
    }
    ...
    public function buscarPorNombreAction() {
        ...
        return
                        $this
                        ->render(
                                'JazzywebAulasMentorAlimentosBundle:Default:buscarPorNombre.html.twig', $params
        );
    }
